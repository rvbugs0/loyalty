...
var urlFormed="AddVendor.php?name="+encodeURI(name)+"&username="+encodeURI(username)+"&email="+encodeURI(email)+"&phone="+encodeURI(phone)+"&city="+encodeURI(city)+"&address="+encodeURI(address);
$.ajax({
