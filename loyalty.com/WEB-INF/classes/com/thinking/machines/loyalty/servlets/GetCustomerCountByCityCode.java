...
public class GetCustomerCountByCityCode extends HttpServlet
{
...
long count=loyaltyApplication.getCustomerCountByCityCode(Integer.parseInt(rq.getParameter("cityCode")));
pw.println("{");
