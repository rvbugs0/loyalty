...
public class GetAllCustomersByCityCode extends HttpServlet
{
...
ArrayList<CustomerBLInterface>customers=loyaltyApplication.getAllCustomersByCityCode(Integer.parseInt(rq.getParameter("cityCode").trim()));
