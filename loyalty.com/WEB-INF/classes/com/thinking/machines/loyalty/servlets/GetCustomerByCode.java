...
public class GetCustomerByCode extends HttpServlet
{
...
CustomerBLInterface customerInterface=loyaltyApplication.getCustomerByCode(Integer.parseInt(rq.getParameter("code")));
pw.println("{");
