...
public class GetAllCustomersByCustomerType extends HttpServlet
{
...
ArrayList<CustomerBLInterface>customers=loyaltyApplication.getAllCustomersByCustomerType(com.thinking.machines.loyalty.interfaces.CustomerDAOInterface.CustomerType.valueOf(rq.getParameter("customerType")));
