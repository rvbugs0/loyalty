...
public class GetAllCustomersByOccupation extends HttpServlet
{
...
ArrayList<CustomerBLInterface>customers=loyaltyApplication.getAllCustomersByOccupation(rq.getParameter("occupation").trim());
