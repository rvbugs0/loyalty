...
public class GetCustomerByEmailId extends HttpServlet
{
...
CustomerBLInterface customerInterface=loyaltyApplication.getCustomerByEmailId(rq.getParameter("emailId"));
pw.println("{");
