...
public class GetCustomerByUsername extends HttpServlet
{
...
CustomerBLInterface customerInterface=loyaltyApplication.getCustomerByUsername(rq.getParameter("username"));
pw.println("{");
