...
--
-- Temporary view structure for view `marital_details_view`
--

DROP TABLE IF EXISTS `marital_details_view`;
/*!50001 DROP VIEW IF EXISTS `marital_details_view`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `marital_details_view` AS SELECT 
 1 AS `customer_code`,
 1 AS `name`,
 1 AS `username`,
 1 AS `password`,
 ...
 1 AS `mail_id`,
 1 AS `spouse_name`,
 1 AS `spouse_date_of_birth`,
 1 AS `anniversary_date`,
 1 AS `spouse_occupation`,
 1 AS `number_of_girl_child`,
 1 AS `number_of_boy_child`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Final view structure for view `marital_details_view`
--
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `get_marital_details_by_customer_code` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_marital_details_by_customer_code`(in v_customer_code int)
BEGIN
